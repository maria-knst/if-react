...
const Calendar = ({ selectedDates, setSelectedDates }) => {
  ...
  return (
    <div className="top__calendar">
      ...
      <CalendarMonth id_="current" selectedDates={selectedDates} setSelectedDates={setSelectedDates} />
      <CalendarMonth id_="next" selectedDates={selectedDates} setSelectedDates={setSelectedDates} />
